...
const ledmap PROGMEM ledmaps[] = {
    [MAC_FN] = LAYOUT_all{
        _______,   MAGENT,    MAGENT,    BLUE,    MAGENT,    GREEN,     GREEN,     PINK,      PINK,      PINK,      PINK,      _______,   _______,   RED,               _______, _______, _______,
    ...
    [WIN_FN] = LAYOUT_all{
        _______,   MAGENT,    MAGENT,    MAGENT,    MAGENT,    GREEN,     GREEN,     PINK,      PINK,      PINK,      PINK,      _______,   _______,   _______,         _______, _______, _______,
        _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,                  _______,
