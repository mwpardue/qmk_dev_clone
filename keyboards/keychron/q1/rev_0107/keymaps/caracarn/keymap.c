...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_all(
        ...
        TD(TD_LCMD_CAPS),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,             KC_DEL,
    ...
    [MAC_FN] = LAYOUT_all(
        ...
        KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,  RGB_VAD,  RGB_VAI,            KC_TRNS,  TG(MAC_FN),   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
