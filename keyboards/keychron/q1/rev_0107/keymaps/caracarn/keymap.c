...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_all(
        ...
        LT(MAC_FN, KC_CAPS),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT,             KC_DEL,
    ...
    [MAC_FN] = LAYOUT_all(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  KC_TRNS,  KC_7,     KC_8,     KC_9,      KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,            KC_TRNS,
        TG(MAC_FN),  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  KC_TRNS,  KC_4,     KC_5,     KC_6,      KC_DOT,   KC_TRNS,             KC_TRNS,            KC_TRNS,
        KC_TRNS,            KC_LTTOG, KC_LATOG, KC_TKTOG, KC_FCTOG, KC_TRNS,  KC_TRNS,  KC_1,     KC_2,      KC_3,     KC_TRNS,             KC_TRNS,     KC_TRNS,
        KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_0,     RGB_VAD,  RGB_VAI,             KC_TRNS,  TG(MAC_FN),   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
    ...
    [WIN_FN] = LAYOUT_all(
        ...
        KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,  RGB_VAD,  RGB_VAI,            KC_TRNS,  TG(WIN_FN),   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
};
