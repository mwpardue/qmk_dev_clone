...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_jis_86(
         ...
         KC_LCTL,  KC_LALT,  KC_LGUI,  KC_HANJ,                      KC_SPC,                       KC_HAEN,  KC_RGUI, MO(MAC_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_jis_86(
         ...
         KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,             KC_HOME,
         KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RO,    KC_RSFT,  KC_UP,
         KC_LCTL,  KC_LGUI,  KC_LALT,  KC_MHEN,                      KC_SPC,                       KC_HENK,  KC_RALT, MO(WIN_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
